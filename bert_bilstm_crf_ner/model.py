...
class Model(object):
    def __init__(self, config):
        ...
        self.bert_config_file = config["bert_config_file"]
        ...
        # bert模型参数初始化的地方
        # init_checkpoint = "D:/Spyder/plantdata/kgtext_event_extract/src/chinese_L-12_H-768_A-12/bert_model.ckpt"
    ...
    def bert_embedding(self):
        # load bert embedding
        bert_config = modeling.BertConfig.from_json_file(self.bert_config_file)  # 配置文件地址。
